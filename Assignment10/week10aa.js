...
app.get('/aameetings', function(req, res) {
    ...
    // SQL query 
    var thisQuery = `SELECT mtaddress, mtlocation as location, json_agg(json_build_object('day', mtday, 'time', mtstart)) as meetings
                 FROM aameetings  
                 WHERE 'Saturday' = ANY (mtday)
                    GROUP BY mtaddress, mtlocation
                 ;`;
